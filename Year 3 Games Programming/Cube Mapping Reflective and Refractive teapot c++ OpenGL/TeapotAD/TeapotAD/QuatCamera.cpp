...
{
	glm::quat rotation;
	/*TODO:: Complete this function*/ //Week--7--Done?????
...
{
	/*TODO:: Complete this function*/ //Week--7--Done?????
	_orientation = glm::normalize(glm::angleAxis(yaw, WORLDY)*_orientation);
	_orientation = glm::normalize(glm::angleAxis(pitch, WORLDX)*_orientation);
	updateView();
...
void QuatCamera::roll(const float z)  /*TODO:: Complete this function*/
{
	...
	_orientation = glm::normalize(glm::angleAxis(z, WORLDZ)*_orientation);
	updateView();
