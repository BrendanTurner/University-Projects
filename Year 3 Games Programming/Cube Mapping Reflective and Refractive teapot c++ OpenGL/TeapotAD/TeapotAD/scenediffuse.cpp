...
void SceneDiffuse::setLightParams(QuatCamera camera)
{
	...
	prog.setUniform("la", 0.3f, 0.3f, 0.3f);//##added for lab exercise
	prog.setUniform("ls", 0.3f, 0.3f, 0.3f);//##added for lab exercise
...
void SceneDiffuse::render(QuatCamera camera)
{
	...
	prog.setUniform("Kd", 0.51f, 1.0f, 0.49f); // difuse Week--5
	prog.setUniform("ka", 0.51f, 1.0f, 0.49f);//##added for lab exercise
	prog.setUniform("ks", 0.1f, 0.1f, 0.1f);//##added for lab exercise
	...
	//Now set up the teapot 
	 ...
	 prog.setUniform("Kd", 0.46f, 0.29f, 0.0f); // difuse Week--5
	 prog.setUniform("ka", 0.46f, 0.29f, 0.0f);//##added for lab exercise
	 prog.setUniform("ks", 0.29f, 0.29f, 0.29f);//##added for lab exercise
	 teapot->render();
