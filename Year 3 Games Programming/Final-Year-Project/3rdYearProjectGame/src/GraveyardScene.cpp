...
void GraveyardScene::setSceneVariables()
{
	m_dungeon = completeGraveyardDungeon;
	...
	case N:
	{
		...
		m_tileData = "assets/data/mapTiles/graveyard/mapTilesGraveyard.json";
		m_objectData = "assets/data/mapObjects/graveyard/mapObjectsGraveyard.json";
		m_tileSet = "terrainBarren";
		m_objectSet = "overworldObjectsBarren";
		m_background->setColour(185, 66, 244, 255);
		break;
	}
	case F:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/graveyard/mapTilesGraveyard.json";
		m_objectData = "assets/data/mapObjects/graveyard/mapObjectsGraveyardF.json";
		m_tileSet = "terrainBarren";
		m_objectSet = "overworldObjectsBarren";
		m_background->setColour(185, 66, 244, 255);
		break;
	...
	case G:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/graveyard/mapTilesGraveyard.json";
		m_objectData = "assets/data/mapObjects/graveyard/mapObjectsGraveyardG.json";
		m_tileSet = "terrainBarren";
		m_objectSet = "overworldObjectsBarren";
		m_background->setColour(185, 66, 244, 255);
		break;
	...
	case V:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/graveyard/mapTilesGraveyard.json";
		m_objectData = "assets/data/mapObjects/graveyard/mapObjectsGraveyardV.json";
	...
	case I:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/graveyard/mapTilesGraveyard.json";
		m_objectData = "assets/data/mapObjects/graveyard/mapObjectsGraveyardI.json";
		m_tileSet = "terrainBarren";
		m_objectSet = "overworldObjectsBarren";
		m_background->setColour(185, 66, 244, 255);
		break;
