...
void ForestScene::setSceneVariables()
{
	m_dungeon = completeForestDungeon;
	...
	case N:
	{
		...
		m_tileData = "assets/data/mapTiles/forest/mapTilesForest.json";
		m_objectData = "assets/data/mapObjects/forest/mapObjectsForest.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(72, 152, 72, 255);
		break;
	}
	case F:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/forest/mapTilesForest.json";
		m_objectData = "assets/data/mapObjects/forest/mapObjectsForestF.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(72, 152, 72, 255);
		break;
	...
	case G:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/forest/mapTilesForest.json";
		m_objectData = "assets/data/mapObjects/forest/mapObjectsForestG.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(72, 152, 72, 255);
		break;
	...
	case V:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/forest/mapTilesForest.json";
		m_objectData = "assets/data/mapObjects/forest/mapObjectsForestV.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(72, 152, 72, 255);
		break;
	...
	case I:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/forest/mapTilesForest.json";
		m_objectData = "assets/data/mapObjects/forest/mapObjectsForestI.json";
