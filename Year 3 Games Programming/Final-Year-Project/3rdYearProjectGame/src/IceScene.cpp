...
void IceScene::setSceneVariables()
{
	m_dungeon = completeIceDungeon;
	...
	case N:
	{
		...
		m_tileData = "assets/data/mapTiles/ice/mapTilesIce.json";
		m_objectData = "assets/data/mapObjects/ice/mapObjectsIce.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(66, 238, 244, 255);
		break;
	}
	case F:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/ice/mapTilesIce.json";
		m_objectData = "assets/data/mapObjects/ice/mapObjectsIceF.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(66, 92, 244, 255);
		break;
	}
	case G:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/ice/mapTilesIce.json";
		m_objectData = "assets/data/mapObjects/ice/mapObjectsIceG.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(66, 92, 244, 255);
		break;
	...
	case V:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/ice/mapTilesIce.json";
		m_objectData = "assets/data/mapObjects/ice/mapObjectsIceV.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(66, 238, 244, 255);
		break;
	...
	case I:
	{
		m_background = new BackgroundObject();// if not using an image
		m_tileData = "assets/data/mapTiles/ice/mapTilesIce.json";
		m_objectData = "assets/data/mapObjects/ice/mapObjectsIceI.json";
		m_tileSet = "terrainNature";
		m_objectSet = "overworldObjectsNature";
		m_background->setColour(66, 92, 244, 255);
		break;
