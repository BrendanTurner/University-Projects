...
int main()
{
	...
	lightingShader.setInt("hatch.hatch0", 2);
	lightingShader.setInt("hatch.hatch1", 3);
	lightingShader.setInt("hatch.hatch2", 4);
	lightingShader.setInt("hatch.hatch3", 5);
	lightingShader.setInt("hatch.hatch4", 6);
	lightingShader.setInt("hatch.hatch5", 7);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
		//ink colour
		lightingShader.setVec4("hatchColour", 0.141, 0.141, 0.322, 1.0);//blue
        // directional light
        ...
        lightingShader.setFloat("spotLight.linear", 0.045);
		...
		//set the toggle uniform
		lightingShader.setInt("filter", tog);
